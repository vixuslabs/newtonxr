...
import { JointOrder, JointType } from "../hooks/useHandHooks.js";
import {
  // _direction,
  _position,
  _quaternion,
...
export const oldestJointTypeMappings = new Map<XRHandJoint, JointType>([
...
export const oldJointTypeMappings = new Map<XRHandJoint, JointType>([
  // Wrist and thumb joints
  ["wrist", JointType.Fixed],
  ...
  ["index-finger-phalanx-proximal", JointType.Revolute],
  ["index-finger-phalanx-intermediate", JointType.Revolute],
  ["index-finger-phalanx-distal", JointType.Revolute],
  ["index-finger-tip", JointType.Fixed],
  ...
  ["middle-finger-phalanx-proximal", JointType.Revolute],
  ["middle-finger-phalanx-intermediate", JointType.Revolute],
  ["middle-finger-phalanx-distal", JointType.Revolute],
  ["middle-finger-tip", JointType.Fixed],
  ...
  ["ring-finger-phalanx-proximal", JointType.Revolute],
  ["ring-finger-phalanx-intermediate", JointType.Revolute],
  ["ring-finger-phalanx-distal", JointType.Revolute],
  ["ring-finger-tip", JointType.Fixed],
  ...
  ["pinky-finger-phalanx-proximal", JointType.Revolute],
  ["pinky-finger-phalanx-intermediate", JointType.Revolute],
  ["pinky-finger-phalanx-distal", JointType.Revolute],
  ["pinky-finger-tip", JointType.Fixed],
]);
...
export type PalmJointMap = Map<PalmJointNames, PalmProperties>;
[3, 8, 15];
...
export default class Newton {
  ...
  private buildHand() {
    ...
    jointNames.forEach((jointName) => {
      ...
      // const sphericalImpulseJoint = this.rapierWorld.createImpulseJoint(
      //   sphericalJointDesc,
      //   kinematicJointRb,
      //   dynamicJointRb,
      //   true,
    ...
    for (const boneName of boneNames) {
      ...
      switch (bottomJointType) {
        ...
        case JointType.Revolute: {
          ...
          // (impulseJoint as RAPIER.RevoluteImpulseJoint).configureMotorPosition(
          //   0,
          //   1.0e4,
          //   122,
          // );

          (impulseJoint as RAPIER.RevoluteImpulseJoint).configureMotorModel(
            RAPIER.MotorModel.ForceBased,
          );

          (impulseJoint as RAPIER.RevoluteImpulseJoint).configureMotorVelocity(
            0,
            122,
          );
